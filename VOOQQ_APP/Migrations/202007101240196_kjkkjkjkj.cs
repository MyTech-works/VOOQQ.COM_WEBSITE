namespace VOOQQ_APP.Migrations
{
    ...
    public partial class kjkkjkjkj : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.M_Category", "M_CategoryId", c => c.Long(nullable: false, identity: true));
            AddColumn("dbo.M_Category", "M_CategoryName", c => c.String());
            ...
            AddPrimaryKey("dbo.M_Category", "M_CategoryId");
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.M_Category", "M_CategoryName");
            DropColumn("dbo.M_Category", "M_CategoryId");
