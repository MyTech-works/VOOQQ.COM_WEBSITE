    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Success:
                    ...
                    if (user.Id == "17f77cf4-b103-4bd8-b912-3ae38c666c2d")
                    {
        ...
        public void send(string EmailID)
        {
            try
            {
                ...
                //cust = db.customers.Where(a => a.EmailID == EmailID).FirstOrDefault();

                string message = System.IO.File.ReadAllText(Request.PhysicalApplicationPath + "MailTemplates\\Verify.config");
                message = message.Replace("{UserName}", EmailID).Replace("{Password}", "Registration");
                ServicePointManager.SecurityProtocol = SecurityProtocolType.Ssl3;

                var senderEmail = new MailAddress("sales@technobrainkwt.com.", "technobrainkwt.com");
                var receiverEmail = new MailAddress(EmailID, "Receiver");
                var password = "Tech@1234";
