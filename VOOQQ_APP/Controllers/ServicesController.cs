...
namespace VOOQQ_APP.Controllers
{
    public class ServicesController : Controller
    {
        ...
        {
            Services forsale = db.Services.Find(id);
            forsale.Status = true;
        ...
        // GET: Services
        public ActionResult Index(int? Vid, string Location, string ServiceCategoryId)
        {

             
            ViewBag.ServiceCategory = db.ServiceCategory.ToList();
            ServiceCategoryId = ServiceCategoryId == null || ServiceCategoryId == "" ? "0" : ServiceCategoryId;
            ...
            SqlParameter[] Parameters = {
                ...
                new SqlParameter("@ServiceCategoryId", ServiceCategoryId),
             
            };

       
            ViewBag.data = db.Database.SqlQuery<ServiceModel>("[dbo].[spGetListingData_Service]  @Vid, @Location, @ServiceCategoryId", Parameters).ToList();
            return View();
        }
        ...
        public ActionResult Details(string id)
        {
            id = id == null ? "" : id;
            SqlParameter[] Parameters = {
                    new SqlParameter("@ServiceId", id.ToString())};
            ViewBag.data = db.Database.SqlQuery<ServiceModel>(" [dbo].[spGetListingData_Service_Details] @ServiceId", Parameters).ToList();
            long ids = Convert.ToInt64(id);
            Services forsale = db.Services.Find(ids);
        ...
        public ActionResult Create([Bind(Include = "ServiceId,VId,UserId,Tiltle,ServiceCategoryId,Location,YearofExperience,MobileNumber,LandPhone,Email,Description,Image1,Image2,Image3,Date,Views,Status")] Services services, HttpPostedFileBase file1, HttpPostedFileBase file2, HttpPostedFileBase file3)
        {
            ViewBag.ServiceCategory = db.ServiceCategory.ToList();
            if (ModelState.IsValid)
            {
                    ...
                    using (Bitmap bmp = new Bitmap(file1.InputStream, false))
                    {
                        using (Graphics grp = Graphics.FromImage(bmp))
                        {
                            ...
                            using (MemoryStream memoryStream = new MemoryStream())
                            {
                                ...
                                services.Image1 = "/Images/" + file1.FileName;
                            }
                        }
                    }
                }
                ...
                {
                    services.Image1 = "/Images/nullimage.jpg";
                }
                if (file2 != null)
                {
                    string watermarkText = "© Vooqq.Com";
                    ...
                    using (Bitmap bmp = new Bitmap(file2.InputStream, false))
                    {
                        using (Graphics grp = Graphics.FromImage(bmp))
                        {
                            ...
                            using (MemoryStream memoryStream = new MemoryStream())
                            {
                                ...
                                services.Image2 = "/Images/" + file2.FileName;
                            }
                        }
                    }
                }
                ...
                {
                    services.Image2 = "/Images/nullimage.jpg";
                }
                if (file3 != null)
                {
                    string watermarkText = "© Vooqq.Com";
                    ...
                    using (Bitmap bmp = new Bitmap(file3.InputStream, false))
                    {
                        using (Graphics grp = Graphics.FromImage(bmp))
                        {
                            ...
                            using (MemoryStream memoryStream = new MemoryStream())
                            {
                                ...
                                services.Image3 = "/Images/" + file3.FileName;
                            }
                        }
                    }
                }
                ...
                {
                    services.Image3 = "/Images/nullimage.jpg";
                }
                services.UserId = User.Identity.GetUserId();
                services.Date = DateTime.Now;
                services.StratDate = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,EndDate,status,StratDate,ServiceId,VId,UserId,Tiltle,ServiceCategoryId,Location,YearofExperience,MobileNumber,LandPhone,Email,Description,Image1,Image2,Image3,Date,Views,Status")] Services services, HttpPostedFileBase file1, HttpPostedFileBase file2, HttpPostedFileBase file3)
        {
            ViewBag.ServiceCategory = db.ServiceCategory.ToList();
            if (ModelState.IsValid)
            {
