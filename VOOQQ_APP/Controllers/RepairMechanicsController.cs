...
{
    public class RepairMechanicsController : Controller
    {
        ...
        // GET: RepairMechanics
        public ActionResult Index(int? Vid, string Location, string RCategoryId)
        {
            ...
            Vid = Vid == null ? 1 : Vid;
            RCategoryId = RCategoryId == null || RCategoryId == "" ? "0" : RCategoryId;
            SqlParameter[] Parameters = {
                new SqlParameter("@Vid", Vid),
                new SqlParameter("@Location", string.IsNullOrWhiteSpace(Location)? DBNull.Value: (object)Location),
                new SqlParameter("@RCategoryId",  RCategoryId)
            };
            ViewBag.data = db.Database.SqlQuery<RepairMechanicModel>("[dbo].[spGetListingData_RepairMechanics] @Vid, @Location, @RCategoryId", Parameters).ToList();
            return View();
        ...
        // POST: RepairMechanics/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "RepairMechanicId,VId,UserId,Title,RCategoryId,MobileNumber,LandPhone,Email,Description,Location,Image1,Image2,Image3,Date,Views,Status,YearsOfExperiance")] RepairMechanic repairMechanic, HttpPostedFileBase file1, HttpPostedFileBase file2, HttpPostedFileBase file3)
        {
            ViewBag.rep = db.RCategory.ToList();
            ...
            if (ModelState.IsValid)
            {
                ...
                repairMechanic.UserId = User.Identity.GetUserId();
                repairMechanic.Date = DateTime.Now;
                repairMechanic.StratDate = DateTime.Now;
